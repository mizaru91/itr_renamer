...
class DragView: NSView {
    ...
    private var acceptedFileExtensions = ["aac","aif","aiff","avi","bmp","dxf","fla","flac","flv","ico","gif","jpg","jpeg","m4a","mov","mp2","mp3","mp4","mpg","mpeg","mxf","ogg","png","psd","raw","svg","tga","tif","tiff","vsd","wav","wma","wmv"]
